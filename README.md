...
<div align="center">
  <img src="image.png" alt="Project Preview" width="500">
  <br>
  <em>معاينة لشكل النقطة الحمراء الناتجة عن الكود</em>
</div>

---

### 📖 نبذة عن المشروع
مشروع تعليمي بسيط لتعلم أساسيات الرسم باستخدام مكتبة **OpenGL** و **GLUT**. يقوم البرنامج برسم نقطة حمراء في إحداثيات محددة مع شرح مفصل "بالعامية المصرية" داخل الكود وفي هذا الملف لكل دالة مستخدمة، لتبسيط المفاهيم للمبتدئين.
